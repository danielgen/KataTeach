...
from common_utils import (
    get_device, select_move_with_sampling, create_sgf, loc_to_sgf_coords,
    calculate_dynamic_threshold, _idx361_from_loc, _xy_from_loc, _loc_to_sgf, _loc_to_human_coord
)
...
def play_single_game(model, game_id: int, board_size: int = 19, prob_threshold: float = 0.01, 
    ...
    for move_number in range(max_moves):
        ...
        best_move, best_prob, was_sampled = select_move_with_sampling(moves_and_probs, current_threshold)
